...
// usage: node build.mjs   ->  thaicolor-app-peak-v1.6.3.html
...
`;
writeFileSync("thaicolor-app-peak-v1.6.3.html", html);
console.log("built thaicolor-app-peak-v1.6.3.html", (html.length / 1048576).toFixed(2), "MB");
