...
| 10⁻¹²² convergence at N≈57 | **[soft]** | "suggestive" | ~~"the residual reaches the de Sitter floor at the CMB's N"~~ — rests on an un-derived e⁻⁵ᴺ exponent; e⁻³·⁵ᴺ breaks it |
...
- **The "+3" spread** — **[soft]**. The two measured anchors (CMB ⇒ N≈57; the 10⁻¹²² floor) *demand* a dilution exponent k≈4.93; the hand-wave 2+3=5 hits it, the rigorous 2+1.5=3.5 misses. Deriving the spread is the smoothness half of Problem A. (`code/backcalc_from_cmb_floor.py`.)
