...
print("== reading ==")
print("  * The '63 orders short' is a BOOKKEEPING artifact: it counted only 57 e-folds of")
print("    inflation and stopped at inflation's end, but compared to TODAY's floor. Curvature")
print("    keeps diluting a^-2 for the whole aeon (another ~66 e-folds of expansion).")
print("  * Done correctly, item 1 IS the standard FLATNESS problem, and curvature-heavy is the")
print("    EASIEST case for it (inflation is built to flatten curvature). It is solved by enough")
print(f"    TOTAL e-folds: N_total >~ {Nmin(0.01):.0f}.")
